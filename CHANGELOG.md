...
- Ink sized to the take: a take waiting for its words holds their place with ink shaped like the words to come. On home it takes the shape of the row the record becomes, so a close guess lands without a jump; recording more under Whisper, which hears nothing live, lays the ink after your last word, where the new words will start. The size comes from how long you actually spoke (pauses and silence count for nothing) and from how fast you speak each language, which the phone learns from your own takes and keeps to itself.
