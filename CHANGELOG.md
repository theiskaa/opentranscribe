...
- VoiceOver names every model control: a download with its size, its progress in percent, Cancel, Retry, Remove, and which model in the list is in use.
