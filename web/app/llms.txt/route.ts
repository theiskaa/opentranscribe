...
- Transcription: on-device, engine-agnostic; the app refuses any engine that does not declare it runs on the device. Three engines ship, SpeechAnalyzer (iOS 26), Dictation, and Whisper (whisper.cpp, one downloaded model for every language) (the classic recognizer), switchable in the app
