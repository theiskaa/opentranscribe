...
- Re-transcribe all: a bulk run that lets a newer engine re-hear the whole journal, part of the club
- Club: a one-time purchase that supports the app ($25 in the US; the price follows the App Store region); direct StoreKit with no purchase SDK, no account, and no server
